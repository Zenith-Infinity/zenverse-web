...
function fillTheList(value) {
    ...
    let content = 
    fillGame.replace('<a type="button" href="detailed.html?gameId=#guid" class="group animate-pulse pointer-events-none block backdrop-blur-xl transform hover:scale-105 hover:backdrop-blur-none transition duration-300 rounded-lg">', '<a type="button" onclick="saveGameIdAndNavigate(\'' + value._id + '\')" class="group block backdrop-blur-xl transform hover:scale-105 hover:backdrop-blur-none transition duration-300 rounded-lg">')
